...
function ProteomeComparison(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.compare_proteomes = function (input, _callback, _errorCallback) {
        ...
        return json_call_ajax("ProteomeComparison.compare_proteomes",
