...
/**
 * <p>Original spec-file type: ProteomeComparisonParams</p>
 * <pre>
...
public class ProteomeComparisonParams {
    ...
    public ProteomeComparisonParams withGenome1ws(String genome1ws) {
        this.genome1ws = genome1ws;
        return this;
    }
    ...
    public ProteomeComparisonParams withGenome1id(String genome1id) {
        this.genome1id = genome1id;
        return this;
    }
    ...
    public ProteomeComparisonParams withGenome2ws(String genome2ws) {
        this.genome2ws = genome2ws;
        return this;
    }
    ...
    public ProteomeComparisonParams withGenome2id(String genome2id) {
        this.genome2id = genome2id;
        return this;
    }
    ...
    public ProteomeComparisonParams withSubBbhPercent(Double subBbhPercent) {
        this.subBbhPercent = subBbhPercent;
        return this;
    }
    ...
    public ProteomeComparisonParams withMaxEvalue(String maxEvalue) {
        this.maxEvalue = maxEvalue;
        return this;
    }
    ...
    public ProteomeComparisonParams withOutputWs(String outputWs) {
        this.outputWs = outputWs;
        return this;
    }
    ...
    public ProteomeComparisonParams withOutputId(String outputId) {
        this.outputId = outputId;
        return this;
    }
    ...
    public String toString() {
        return ((((((((((((((((((("ProteomeComparisonParams"+" [genome1ws=")+ genome1ws)+", genome1id=")+ genome1id)+", genome2ws=")+ genome2ws)+", genome2id=")+ genome2id)+", subBbhPercent=")+ subBbhPercent)+", maxEvalue=")+ maxEvalue)+", outputWs=")+ outputWs)+", outputId=")+ outputId)+", additionalProperties=")+ additionalProperties)+"]");
    }
