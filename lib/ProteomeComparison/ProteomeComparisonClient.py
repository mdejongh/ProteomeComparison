...
class ProteomeComparison(object):
    ...
    def compare_proteomes(self, input, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method compare_proteomes: argument json_rpc_context is not type dict as required.')
        resp = self._call('ProteomeComparison.compare_proteomes',
